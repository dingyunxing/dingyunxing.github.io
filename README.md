# A personal blog based on Lanyon

This is a jekyll template based on [Lanyon](https://github.com/poole/lanyon). Borrow some code and ideas from a live demo [here](http://codinfox.github.io).
